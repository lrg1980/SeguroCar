...
class Formulario extends Component {
     ...
     // refs son para leer los valores de los valores de un formulario
     ...
     cotizarSeguro = (e) => {
          ...
          // reiniciar el formulario y lo deja por defecto una vez que el usuario indica su cotización (opcional)
